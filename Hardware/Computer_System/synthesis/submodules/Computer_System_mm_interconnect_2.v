...
module Computer_System_mm_interconnect_2 (
		...
		output wire [3:0]  Dot_Product_avalon_slave_address,                                         //                                           Dot_Product_avalon_slave.address
		output wire        Dot_Product_avalon_slave_write,                                           //                                                                   .write
		output wire        Dot_Product_avalon_slave_read,                                            //                                                                   .read
		input  wire [31:0] Dot_Product_avalon_slave_readdata,                                        //                                                                   .readdata
		output wire [31:0] Dot_Product_avalon_slave_writedata,                                       //                                                                   .writedata
		input  wire        Dot_Product_avalon_slave_waitrequest                                      //                                                                   .waitrequest
	);
	...
	wire   [31:0] dot_product_avalon_slave_agent_m0_readdata;                           // Dot_Product_avalon_slave_translator:uav_readdata -> Dot_Product_avalon_slave_agent:m0_readdata
	wire          dot_product_avalon_slave_agent_m0_waitrequest;                        // Dot_Product_avalon_slave_translator:uav_waitrequest -> Dot_Product_avalon_slave_agent:m0_waitrequest
	wire          dot_product_avalon_slave_agent_m0_debugaccess;                        // Dot_Product_avalon_slave_agent:m0_debugaccess -> Dot_Product_avalon_slave_translator:uav_debugaccess
	wire   [20:0] dot_product_avalon_slave_agent_m0_address;                            // Dot_Product_avalon_slave_agent:m0_address -> Dot_Product_avalon_slave_translator:uav_address
	wire    [3:0] dot_product_avalon_slave_agent_m0_byteenable;                         // Dot_Product_avalon_slave_agent:m0_byteenable -> Dot_Product_avalon_slave_translator:uav_byteenable
	wire          dot_product_avalon_slave_agent_m0_read;                               // Dot_Product_avalon_slave_agent:m0_read -> Dot_Product_avalon_slave_translator:uav_read
	wire          dot_product_avalon_slave_agent_m0_readdatavalid;                      // Dot_Product_avalon_slave_translator:uav_readdatavalid -> Dot_Product_avalon_slave_agent:m0_readdatavalid
	wire          dot_product_avalon_slave_agent_m0_lock;                               // Dot_Product_avalon_slave_agent:m0_lock -> Dot_Product_avalon_slave_translator:uav_lock
	wire   [31:0] dot_product_avalon_slave_agent_m0_writedata;                          // Dot_Product_avalon_slave_agent:m0_writedata -> Dot_Product_avalon_slave_translator:uav_writedata
	wire          dot_product_avalon_slave_agent_m0_write;                              // Dot_Product_avalon_slave_agent:m0_write -> Dot_Product_avalon_slave_translator:uav_write
	wire    [2:0] dot_product_avalon_slave_agent_m0_burstcount;                         // Dot_Product_avalon_slave_agent:m0_burstcount -> Dot_Product_avalon_slave_translator:uav_burstcount
	wire          dot_product_avalon_slave_agent_rf_source_valid;                       // Dot_Product_avalon_slave_agent:rf_source_valid -> Dot_Product_avalon_slave_agent_rsp_fifo:in_valid
	wire  [112:0] dot_product_avalon_slave_agent_rf_source_data;                        // Dot_Product_avalon_slave_agent:rf_source_data -> Dot_Product_avalon_slave_agent_rsp_fifo:in_data
	wire          dot_product_avalon_slave_agent_rf_source_ready;                       // Dot_Product_avalon_slave_agent_rsp_fifo:in_ready -> Dot_Product_avalon_slave_agent:rf_source_ready
	wire          dot_product_avalon_slave_agent_rf_source_startofpacket;               // Dot_Product_avalon_slave_agent:rf_source_startofpacket -> Dot_Product_avalon_slave_agent_rsp_fifo:in_startofpacket
	wire          dot_product_avalon_slave_agent_rf_source_endofpacket;                 // Dot_Product_avalon_slave_agent:rf_source_endofpacket -> Dot_Product_avalon_slave_agent_rsp_fifo:in_endofpacket
	wire          dot_product_avalon_slave_agent_rsp_fifo_out_valid;                    // Dot_Product_avalon_slave_agent_rsp_fifo:out_valid -> Dot_Product_avalon_slave_agent:rf_sink_valid
	wire  [112:0] dot_product_avalon_slave_agent_rsp_fifo_out_data;                     // Dot_Product_avalon_slave_agent_rsp_fifo:out_data -> Dot_Product_avalon_slave_agent:rf_sink_data
	wire          dot_product_avalon_slave_agent_rsp_fifo_out_ready;                    // Dot_Product_avalon_slave_agent:rf_sink_ready -> Dot_Product_avalon_slave_agent_rsp_fifo:out_ready
	wire          dot_product_avalon_slave_agent_rsp_fifo_out_startofpacket;            // Dot_Product_avalon_slave_agent_rsp_fifo:out_startofpacket -> Dot_Product_avalon_slave_agent:rf_sink_startofpacket
	wire          dot_product_avalon_slave_agent_rsp_fifo_out_endofpacket;              // Dot_Product_avalon_slave_agent_rsp_fifo:out_endofpacket -> Dot_Product_avalon_slave_agent:rf_sink_endofpacket
	wire          dot_product_avalon_slave_agent_rdata_fifo_src_valid;                  // Dot_Product_avalon_slave_agent:rdata_fifo_src_valid -> Dot_Product_avalon_slave_agent_rdata_fifo:in_valid
	wire   [33:0] dot_product_avalon_slave_agent_rdata_fifo_src_data;                   // Dot_Product_avalon_slave_agent:rdata_fifo_src_data -> Dot_Product_avalon_slave_agent_rdata_fifo:in_data
	wire          dot_product_avalon_slave_agent_rdata_fifo_src_ready;                  // Dot_Product_avalon_slave_agent_rdata_fifo:in_ready -> Dot_Product_avalon_slave_agent:rdata_fifo_src_ready
	...
	wire  [111:0] av_config_avalon_av_config_slave_agent_rp_data;                       // AV_Config_avalon_av_config_slave_agent:rp_data -> router_002:sink_data
	...
	wire          dot_product_avalon_slave_agent_rp_valid;                              // Dot_Product_avalon_slave_agent:rp_valid -> router_003:sink_valid
	wire  [111:0] dot_product_avalon_slave_agent_rp_data;                               // Dot_Product_avalon_slave_agent:rp_data -> router_003:sink_data
	wire          dot_product_avalon_slave_agent_rp_ready;                              // router_003:sink_ready -> Dot_Product_avalon_slave_agent:rp_ready
	wire          dot_product_avalon_slave_agent_rp_startofpacket;                      // Dot_Product_avalon_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          dot_product_avalon_slave_agent_rp_endofpacket;                        // Dot_Product_avalon_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [111:0] cmd_mux_src_data;                                                     // cmd_mux:src_data -> AV_Config_avalon_av_config_slave_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                                    // AV_Config_avalon_av_config_slave_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                  // cmd_mux:src_channel -> AV_Config_avalon_av_config_slave_burst_adapter:sink0_channel
	...
	wire  [111:0] av_config_avalon_av_config_slave_burst_adapter_source0_data;          // AV_Config_avalon_av_config_slave_burst_adapter:source0_data -> AV_Config_avalon_av_config_slave_agent:cp_data
	...
	wire    [1:0] av_config_avalon_av_config_slave_burst_adapter_source0_channel;       // AV_Config_avalon_av_config_slave_burst_adapter:source0_channel -> AV_Config_avalon_av_config_slave_agent:cp_channel
	...
	wire          cmd_mux_001_src_valid;                                                // cmd_mux_001:src_valid -> Dot_Product_avalon_slave_burst_adapter:sink0_valid
	wire  [111:0] cmd_mux_001_src_data;                                                 // cmd_mux_001:src_data -> Dot_Product_avalon_slave_burst_adapter:sink0_data
	wire          cmd_mux_001_src_ready;                                                // Dot_Product_avalon_slave_burst_adapter:sink0_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                              // cmd_mux_001:src_channel -> Dot_Product_avalon_slave_burst_adapter:sink0_channel
	wire          cmd_mux_001_src_startofpacket;                                        // cmd_mux_001:src_startofpacket -> Dot_Product_avalon_slave_burst_adapter:sink0_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                          // cmd_mux_001:src_endofpacket -> Dot_Product_avalon_slave_burst_adapter:sink0_endofpacket
	wire          dot_product_avalon_slave_burst_adapter_source0_valid;                 // Dot_Product_avalon_slave_burst_adapter:source0_valid -> Dot_Product_avalon_slave_agent:cp_valid
	wire  [111:0] dot_product_avalon_slave_burst_adapter_source0_data;                  // Dot_Product_avalon_slave_burst_adapter:source0_data -> Dot_Product_avalon_slave_agent:cp_data
	wire          dot_product_avalon_slave_burst_adapter_source0_ready;                 // Dot_Product_avalon_slave_agent:cp_ready -> Dot_Product_avalon_slave_burst_adapter:source0_ready
	wire    [1:0] dot_product_avalon_slave_burst_adapter_source0_channel;               // Dot_Product_avalon_slave_burst_adapter:source0_channel -> Dot_Product_avalon_slave_agent:cp_channel
	wire          dot_product_avalon_slave_burst_adapter_source0_startofpacket;         // Dot_Product_avalon_slave_burst_adapter:source0_startofpacket -> Dot_Product_avalon_slave_agent:cp_startofpacket
	wire          dot_product_avalon_slave_burst_adapter_source0_endofpacket;           // Dot_Product_avalon_slave_burst_adapter:source0_endofpacket -> Dot_Product_avalon_slave_agent:cp_endofpacket
	...
	wire          dot_product_avalon_slave_agent_rdata_fifo_out_valid;                  // Dot_Product_avalon_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] dot_product_avalon_slave_agent_rdata_fifo_out_data;                   // Dot_Product_avalon_slave_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          dot_product_avalon_slave_agent_rdata_fifo_out_ready;                  // avalon_st_adapter_001:in_0_ready -> Dot_Product_avalon_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                                    // avalon_st_adapter_001:out_0_valid -> Dot_Product_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                                     // avalon_st_adapter_001:out_0_data -> Dot_Product_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                                    // Dot_Product_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                                    // avalon_st_adapter_001:out_0_error -> Dot_Product_avalon_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) dot_product_avalon_slave_translator (
		.clk                    (System_PLL_sys_clk_clk),                          //                      clk.clk
		.reset                  (AV_Config_reset_reset_bridge_in_reset_reset),     //                    reset.reset
		.uav_address            (dot_product_avalon_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (dot_product_avalon_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (dot_product_avalon_slave_agent_m0_read),          //                         .read
		.uav_write              (dot_product_avalon_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (dot_product_avalon_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (dot_product_avalon_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (dot_product_avalon_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (dot_product_avalon_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (dot_product_avalon_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (dot_product_avalon_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (dot_product_avalon_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (Dot_Product_avalon_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (Dot_Product_avalon_slave_write),                  //                         .write
		.av_read                (Dot_Product_avalon_slave_read),                   //                         .read
		.av_readdata            (Dot_Product_avalon_slave_readdata),               //                         .readdata
		.av_writedata           (Dot_Product_avalon_slave_writedata),              //                         .writedata
		.av_waitrequest         (Dot_Product_avalon_slave_waitrequest),            //                         .waitrequest
		.av_begintransfer       (),                                                //              (terminated)
		.av_beginbursttransfer  (),                                                //              (terminated)
		.av_burstcount          (),                                                //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) dot_product_avalon_slave_agent (
		.clk                     (System_PLL_sys_clk_clk),                                       //             clk.clk
		.reset                   (AV_Config_reset_reset_bridge_in_reset_reset),                  //       clk_reset.reset
		.m0_address              (dot_product_avalon_slave_agent_m0_address),                    //              m0.address
		.m0_burstcount           (dot_product_avalon_slave_agent_m0_burstcount),                 //                .burstcount
		.m0_byteenable           (dot_product_avalon_slave_agent_m0_byteenable),                 //                .byteenable
		.m0_debugaccess          (dot_product_avalon_slave_agent_m0_debugaccess),                //                .debugaccess
		.m0_lock                 (dot_product_avalon_slave_agent_m0_lock),                       //                .lock
		.m0_readdata             (dot_product_avalon_slave_agent_m0_readdata),                   //                .readdata
		.m0_readdatavalid        (dot_product_avalon_slave_agent_m0_readdatavalid),              //                .readdatavalid
		.m0_read                 (dot_product_avalon_slave_agent_m0_read),                       //                .read
		.m0_waitrequest          (dot_product_avalon_slave_agent_m0_waitrequest),                //                .waitrequest
		.m0_writedata            (dot_product_avalon_slave_agent_m0_writedata),                  //                .writedata
		.m0_write                (dot_product_avalon_slave_agent_m0_write),                      //                .write
		.rp_endofpacket          (dot_product_avalon_slave_agent_rp_endofpacket),                //              rp.endofpacket
		.rp_ready                (dot_product_avalon_slave_agent_rp_ready),                      //                .ready
		.rp_valid                (dot_product_avalon_slave_agent_rp_valid),                      //                .valid
		.rp_data                 (dot_product_avalon_slave_agent_rp_data),                       //                .data
		.rp_startofpacket        (dot_product_avalon_slave_agent_rp_startofpacket),              //                .startofpacket
		.cp_ready                (dot_product_avalon_slave_burst_adapter_source0_ready),         //              cp.ready
		.cp_valid                (dot_product_avalon_slave_burst_adapter_source0_valid),         //                .valid
		.cp_data                 (dot_product_avalon_slave_burst_adapter_source0_data),          //                .data
		.cp_startofpacket        (dot_product_avalon_slave_burst_adapter_source0_startofpacket), //                .startofpacket
		.cp_endofpacket          (dot_product_avalon_slave_burst_adapter_source0_endofpacket),   //                .endofpacket
		.cp_channel              (dot_product_avalon_slave_burst_adapter_source0_channel),       //                .channel
		.rf_sink_ready           (dot_product_avalon_slave_agent_rsp_fifo_out_ready),            //         rf_sink.ready
		.rf_sink_valid           (dot_product_avalon_slave_agent_rsp_fifo_out_valid),            //                .valid
		.rf_sink_startofpacket   (dot_product_avalon_slave_agent_rsp_fifo_out_startofpacket),    //                .startofpacket
		.rf_sink_endofpacket     (dot_product_avalon_slave_agent_rsp_fifo_out_endofpacket),      //                .endofpacket
		.rf_sink_data            (dot_product_avalon_slave_agent_rsp_fifo_out_data),             //                .data
		.rf_source_ready         (dot_product_avalon_slave_agent_rf_source_ready),               //       rf_source.ready
		.rf_source_valid         (dot_product_avalon_slave_agent_rf_source_valid),               //                .valid
		.rf_source_startofpacket (dot_product_avalon_slave_agent_rf_source_startofpacket),       //                .startofpacket
		.rf_source_endofpacket   (dot_product_avalon_slave_agent_rf_source_endofpacket),         //                .endofpacket
		.rf_source_data          (dot_product_avalon_slave_agent_rf_source_data),                //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_001_out_0_ready),                            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_001_out_0_valid),                            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_001_out_0_data),                             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_001_out_0_error),                            //                .error
		.rdata_fifo_src_ready    (dot_product_avalon_slave_agent_rdata_fifo_src_ready),          //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (dot_product_avalon_slave_agent_rdata_fifo_src_valid),          //                .valid
		.rdata_fifo_src_data     (dot_product_avalon_slave_agent_rdata_fifo_src_data),           //                .data
		.m0_response             (2'b00),                                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dot_product_avalon_slave_agent_rsp_fifo (
		.clk               (System_PLL_sys_clk_clk),                                    //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),               // clk_reset.reset
		.in_data           (dot_product_avalon_slave_agent_rf_source_data),             //        in.data
		.in_valid          (dot_product_avalon_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (dot_product_avalon_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (dot_product_avalon_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (dot_product_avalon_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (dot_product_avalon_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (dot_product_avalon_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (dot_product_avalon_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (dot_product_avalon_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (dot_product_avalon_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) dot_product_avalon_slave_agent_rdata_fifo (
		.clk               (System_PLL_sys_clk_clk),                              //       clk.clk
		.reset             (AV_Config_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (dot_product_avalon_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (dot_product_avalon_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (dot_product_avalon_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (dot_product_avalon_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (dot_product_avalon_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (dot_product_avalon_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                               // (terminated)
		.csr_read          (1'b0),                                                // (terminated)
		.csr_write         (1'b0),                                                // (terminated)
		.csr_readdata      (),                                                    // (terminated)
	...
	Computer_System_mm_interconnect_2_router_002 router_003 (
		.sink_ready         (dot_product_avalon_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (dot_product_avalon_slave_agent_rp_valid),         //          .valid
		.sink_data          (dot_product_avalon_slave_agent_rp_data),          //          .data
		.sink_startofpacket (dot_product_avalon_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (dot_product_avalon_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (System_PLL_sys_clk_clk),                          //       clk.clk
		.reset              (AV_Config_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.BURSTWRAP_CONST_VALUE     (0),
		.ADAPTER_VERSION           ("13.1")
	) dot_product_avalon_slave_burst_adapter (
		.clk                   (System_PLL_sys_clk_clk),                                       //       cr0.clk
		.reset                 (AV_Config_reset_reset_bridge_in_reset_reset),                  // cr0_reset.reset
		...
		.source0_valid         (dot_product_avalon_slave_burst_adapter_source0_valid),         //   source0.valid
		.source0_data          (dot_product_avalon_slave_burst_adapter_source0_data),          //          .data
		.source0_channel       (dot_product_avalon_slave_burst_adapter_source0_channel),       //          .channel
		.source0_startofpacket (dot_product_avalon_slave_burst_adapter_source0_startofpacket), //          .startofpacket
		.source0_endofpacket   (dot_product_avalon_slave_burst_adapter_source0_endofpacket),   //          .endofpacket
		.source0_ready         (dot_product_avalon_slave_burst_adapter_source0_ready)          //          .ready
	);
	...
	Computer_System_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (System_PLL_sys_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (AV_Config_reset_reset_bridge_in_reset_reset),         // in_rst_0.reset
		.in_0_data      (dot_product_avalon_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (dot_product_avalon_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (dot_product_avalon_slave_agent_rdata_fifo_out_ready), //         .ready
